...
CREDS_DIR="$GITHUB_WORKSPACE/.aws"
mkdir $CREDS_DIR
...
echo "::set-env name=AWS_CONFIG_FILE::$RUNNER_WORKSPACE/.aws/config"
echo "::set-env name=AWS_SHARED_CREDENTIALS_FILE::$RUNNER_WORKSPACE/.aws/credentials"
